module github.com/devguardio/carrier3/v3

go 1.17

require (
	github.com/creack/pty v1.1.17
	github.com/devguardio/identity/go v0.0.0-20220128134049-8682476b852b
...
replace github.com/devguardio/identity/go => /home/aep/proj/devguard/identity/go/
